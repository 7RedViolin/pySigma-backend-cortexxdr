...
def cortexxdr_pipeline() -> ProcessingPipeline:        # Processing pipelines should be defined as functions that return a ProcessingPipeline object.
    return ProcessingPipeline(
        name="CortexXDR example pipeline",
        ...
        items=[
            ProcessingItem(     # This is an example for processing items generated from the mapping above.
                identifier=f"cortexxdr_windows_{service}",
            ...
            ProcessingItem(     # Field mappings
                identifier="cortexxdr_field_mapping",
